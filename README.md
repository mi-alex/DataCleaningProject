...
* [Михаил Александр](https://www.linkedin.com/in/mikhail-alexandre/)

## Выводы

Каждый из трёх представленных методов очистки позволяет избавиться от выбросов при должном подборе параметров.